 ...
 * found in the LICENSE file at https://angular.io/license
 */
function _isNgModuleMetadata(obj){return obj instanceof _angular_core.NgModule}/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var TranslationBundle=function(){function TranslationBundle(_i18nNodesByMsgId,locale,digest,mapperFactory,missingTranslationStrategy,console){void 0===_i18nNodesByMsgId&&(_i18nNodesByMsgId={}),void 0===missingTranslationStrategy&&(missingTranslationStrategy=_angular_core.MissingTranslationStrategy.Warning),this._i18nNodesByMsgId=_i18nNodesByMsgId,this.digest=digest,this.mapperFactory=mapperFactory,this._i18nToHtml=new I18nToHtmlVisitor(_i18nNodesByMsgId,locale,digest,mapperFactory,missingTranslationStrategy,console)}return TranslationBundle.load=function(content,url,serializer,missingTranslationStrategy,console){var _a=serializer.load(content,url),locale=_a.locale,i18nNodesByMsgId=_a.i18nNodesByMsgId,digestFn=function(m){return serializer.digest(m)},mapperFactory=function(m){return serializer.createNameMapper(m)};return new TranslationBundle(i18nNodesByMsgId,locale,digestFn,mapperFactory,missingTranslationStrategy,console)},TranslationBundle.prototype.get=function(srcMsg){var html=this._i18nToHtml.convert(srcMsg);if(html.errors.length)throw new Error(html.errors.join("\n"));return html.nodes},TranslationBundle.prototype.has=function(srcMsg){return this.digest(srcMsg)in this._i18nNodesByMsgId},TranslationBundle}(),I18nToHtmlVisitor=function(){function I18nToHtmlVisitor(_i18nNodesByMsgId,_locale,_digest,_mapperFactory,_missingTranslationStrategy,_console){void 0===_i18nNodesByMsgId&&(_i18nNodesByMsgId={}),this._i18nNodesByMsgId=_i18nNodesByMsgId,this._locale=_locale,this._digest=_digest,this._mapperFactory=_mapperFactory,this._missingTranslationStrategy=_missingTranslationStrategy,this._console=_console,this._contextStack=[],this._errors=[]}return I18nToHtmlVisitor.prototype.convert=function(srcMsg){this._contextStack.length=0,this._errors.length=0;var text=this._convertToText(srcMsg),url=srcMsg.nodes[0].sourceSpan.start.file.url,html=(new HtmlParser).parse(text,url,!0);return{nodes:html.rootNodes,errors:this._errors.concat(html.errors)}},I18nToHtmlVisitor.prototype.visitText=function(text,context){return text.value},I18nToHtmlVisitor.prototype.visitContainer=function(container,context){var _this=this;return container.children.map(function(n){return n.visit(_this)}).join("")},I18nToHtmlVisitor.prototype.visitIcu=function(icu,context){var _this=this,cases=Object.keys(icu.cases).map(function(k){return k+" {"+icu.cases[k].visit(_this)+"}"}),exp=this._srcMsg.placeholders.hasOwnProperty(icu.expression)?this._srcMsg.placeholders[icu.expression]:icu.expression;return"{"+exp+", "+icu.type+", "+cases.join(" ")+"}"},I18nToHtmlVisitor.prototype.visitPlaceholder=function(ph,context){var phName=this._mapper(ph.name);return this._srcMsg.placeholders.hasOwnProperty(phName)?this._srcMsg.placeholders[phName]:this._srcMsg.placeholderToMessage.hasOwnProperty(phName)?this._convertToText(this._srcMsg.placeholderToMessage[phName]):(this._addError(ph,'Unknown placeholder "'+ph.name+'"'),"")},I18nToHtmlVisitor.prototype.visitTagPlaceholder=function(ph,context){var _this=this,tag=""+ph.tag,attrs=Object.keys(ph.attrs).map(function(name){return name+'="'+ph.attrs[name]+'"'}).join(" ");if(ph.isVoid)return"<"+tag+" "+attrs+"/>";var children=ph.children.map(function(c){return c.visit(_this)}).join("");return"<"+tag+" "+attrs+">"+children+"</"+tag+">"},I18nToHtmlVisitor.prototype.visitIcuPlaceholder=function(ph,context){return this._convertToText(this._srcMsg.placeholderToMessage[ph.name])},I18nToHtmlVisitor.prototype._convertToText=function(srcMsg){var nodes,_this=this,id=this._digest(srcMsg),mapper=this._mapperFactory?this._mapperFactory(srcMsg):null;if(this._contextStack.push({msg:this._srcMsg,mapper:this._mapper}),this._srcMsg=srcMsg,this._i18nNodesByMsgId.hasOwnProperty(id))nodes=this._i18nNodesByMsgId[id],this._mapper=function(name){return mapper?mapper.toInternalName(name):name};else{if(this._missingTranslationStrategy===_angular_core.MissingTranslationStrategy.Error){var ctx=this._locale?' for locale "'+this._locale+'"':"";this._addError(srcMsg.nodes[0],'Missing translation for message "'+id+'"'+ctx)}else if(this._console&&this._missingTranslationStrategy===_angular_core.MissingTranslationStrategy.Warning){var ctx=this._locale?' for locale "'+this._locale+'"':"";this._console.warn('Missing translation for message "'+id+'"'+ctx)}nodes=srcMsg.nodes,this._mapper=function(name){return name}}var text=nodes.map(function(node){return node.visit(_this)}).join(""),context=this._contextStack.pop();return this._srcMsg=context.msg,this._mapper=context.mapper,text},I18nToHtmlVisitor.prototype._addError=function(el,msg){this._errors.push(new I18nError(el.sourceSpan,msg))},I18nToHtmlVisitor}(),I18NHtmlParser=function(){function I18NHtmlParser(_htmlParser,translations,translationsFormat,missingTranslation,console){if(void 0===missingTranslation&&(missingTranslation=_angular_core.MissingTranslationStrategy.Warning),this._htmlParser=_htmlParser,translations){var serializer=createSerializer(translationsFormat);this._translationBundle=TranslationBundle.load(translations,"i18n",serializer,missingTranslation,console)}else this._translationBundle=new TranslationBundle({},null,digest,(void 0),missingTranslation,console)}return I18NHtmlParser.prototype.parse=function(source,url,parseExpansionForms,interpolationConfig){void 0===parseExpansionForms&&(parseExpansionForms=!1),void 0===interpolationConfig&&(interpolationConfig=DEFAULT_INTERPOLATION_CONFIG);var parseResult=this._htmlParser.parse(source,url,parseExpansionForms,interpolationConfig);return parseResult.errors.length?new ParseTreeResult(parseResult.rootNodes,parseResult.errors):mergeTranslations(parseResult.rootNodes,this._translationBundle,interpolationConfig,[],{})},I18NHtmlParser}(),CORE="@angular/core",Identifiers=function(){function Identifiers(){}return Identifiers}();Identifiers.ANALYZE_FOR_ENTRY_COMPONENTS={name:"ANALYZE_FOR_ENTRY_COMPONENTS",moduleName:CORE,runtime:_angular_core.ANALYZE_FOR_ENTRY_COMPONENTS},Identifiers.ElementRef={name:"ElementRef",moduleName:CORE,runtime:_angular_core.ElementRef},Identifiers.NgModuleRef={name:"NgModuleRef",moduleName:CORE,runtime:_angular_core.NgModuleRef},Identifiers.ViewContainerRef={name:"ViewContainerRef",moduleName:CORE,runtime:_angular_core.ViewContainerRef},Identifiers.ChangeDetectorRef={name:"ChangeDetectorRef",moduleName:CORE,runtime:_angular_core.ChangeDetectorRef},Identifiers.QueryList={name:"QueryList",moduleName:CORE,runtime:_angular_core.QueryList},Identifiers.TemplateRef={name:"TemplateRef",moduleName:CORE,runtime:_angular_core.TemplateRef},Identifiers.CodegenComponentFactoryResolver={name:"ɵCodegenComponentFactoryResolver",moduleName:CORE,runtime:_angular_core.ɵCodegenComponentFactoryResolver},Identifiers.ComponentFactoryResolver={name:"ComponentFactoryResolver",moduleName:CORE,runtime:_angular_core.ComponentFactoryResolver},Identifiers.ComponentFactory={name:"ComponentFactory",moduleName:CORE,runtime:_angular_core.ComponentFactory},Identifiers.ComponentRef={name:"ComponentRef",moduleName:CORE,runtime:_angular_core.ComponentRef},Identifiers.NgModuleFactory={name:"NgModuleFactory",moduleName:CORE,runtime:_angular_core.NgModuleFactory},Identifiers.createModuleFactory={name:"ɵcmf",moduleName:CORE,runtime:_angular_core.ɵcmf},Identifiers.moduleDef={name:"ɵmod",moduleName:CORE,runtime:_angular_core.ɵmod},Identifiers.moduleProviderDef={name:"ɵmpd",moduleName:CORE,runtime:_angular_core.ɵmpd},Identifiers.RegisterModuleFactoryFn={name:"ɵregisterModuleFactory",moduleName:CORE,runtime:_angular_core.ɵregisterModuleFactory},Identifiers.Injector={name:"Injector",moduleName:CORE,runtime:_angular_core.Injector},Identifiers.ViewEncapsulation={name:"ViewEncapsulation",moduleName:CORE,runtime:_angular_core.ViewEncapsulation},Identifiers.ChangeDetectionStrategy={name:"ChangeDetectionStrategy",moduleName:CORE,runtime:_angular_core.ChangeDetectionStrategy},Identifiers.SecurityContext={name:"SecurityContext",moduleName:CORE,runtime:_angular_core.SecurityContext},Identifiers.LOCALE_ID={name:"LOCALE_ID",moduleName:CORE,runtime:_angular_core.LOCALE_ID},Identifiers.TRANSLATIONS_FORMAT={name:"TRANSLATIONS_FORMAT",moduleName:CORE,runtime:_angular_core.TRANSLATIONS_FORMAT},Identifiers.inlineInterpolate={name:"ɵinlineInterpolate",moduleName:CORE,runtime:_angular_core.ɵinlineInterpolate},Identifiers.interpolate={name:"ɵinterpolate",moduleName:CORE,runtime:_angular_core.ɵinterpolate},Identifiers.EMPTY_ARRAY={name:"ɵEMPTY_ARRAY",moduleName:CORE,runtime:_angular_core.ɵEMPTY_ARRAY},Identifiers.EMPTY_MAP={name:"ɵEMPTY_MAP",moduleName:CORE,runtime:_angular_core.ɵEMPTY_MAP},Identifiers.Renderer={name:"Renderer",moduleName:CORE,runtime:_angular_core.Renderer},Identifiers.viewDef={name:"ɵvid",moduleName:CORE,runtime:_angular_core.ɵvid},Identifiers.elementDef={name:"ɵeld",moduleName:CORE,runtime:_angular_core.ɵeld},Identifiers.anchorDef={name:"ɵand",moduleName:CORE,runtime:_angular_core.ɵand},Identifiers.textDef={name:"ɵted",moduleName:CORE,runtime:_angular_core.ɵted},Identifiers.directiveDef={name:"ɵdid",moduleName:CORE,runtime:_angular_core.ɵdid},Identifiers.providerDef={name:"ɵprd",moduleName:CORE,runtime:_angular_core.ɵprd},Identifiers.queryDef={name:"ɵqud",moduleName:CORE,runtime:_angular_core.ɵqud},Identifiers.pureArrayDef={name:"ɵpad",moduleName:CORE,runtime:_angular_core.ɵpad},Identifiers.pureObjectDef={name:"ɵpod",moduleName:CORE,runtime:_angular_core.ɵpod},Identifiers.purePipeDef={name:"ɵppd",moduleName:CORE,runtime:_angular_core.ɵppd},Identifiers.pipeDef={name:"ɵpid",moduleName:CORE,runtime:_angular_core.ɵpid},Identifiers.nodeValue={name:"ɵnov",moduleName:CORE,runtime:_angular_core.ɵnov},Identifiers.ngContentDef={name:"ɵncd",moduleName:CORE,runtime:_angular_core.ɵncd},Identifiers.unwrapValue={name:"ɵunv",moduleName:CORE,runtime:_angular_core.ɵunv},Identifiers.createRendererType2={name:"ɵcrt",moduleName:CORE,runtime:_angular_core.ɵcrt},Identifiers.RendererType2={name:"RendererType2",moduleName:CORE,runtime:null},Identifiers.ViewDefinition={name:"ɵViewDefinition",moduleName:CORE,runtime:null},Identifiers.createComponentFactory={name:"ɵccf",moduleName:CORE,runtime:_angular_core.ɵccf};/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var STRIP_SRC_FILE_SUFFIXES=/(\.ts|\.d\.ts|\.js|\.jsx|\.tsx)$/,GENERATED_FILE=/\.ngfactory\.|\.ngsummary\./,JIT_SUMMARY_FILE=/\.ngsummary\./,JIT_SUMMARY_NAME=/NgSummary$/,LifecycleHooks={};LifecycleHooks.OnInit=0,LifecycleHooks.OnDestroy=1,LifecycleHooks.DoCheck=2,LifecycleHooks.OnChanges=3,LifecycleHooks.AfterContentInit=4,LifecycleHooks.AfterContentChecked=5,LifecycleHooks.AfterViewInit=6,LifecycleHooks.AfterViewChecked=7,LifecycleHooks[LifecycleHooks.OnInit]="OnInit",LifecycleHooks[LifecycleHooks.OnDestroy]="OnDestroy",LifecycleHooks[LifecycleHooks.DoCheck]="DoCheck",LifecycleHooks[LifecycleHooks.OnChanges]="OnChanges",LifecycleHooks[LifecycleHooks.AfterContentInit]="AfterContentInit",LifecycleHooks[LifecycleHooks.AfterContentChecked]="AfterContentChecked",LifecycleHooks[LifecycleHooks.AfterViewInit]="AfterViewInit",LifecycleHooks[LifecycleHooks.AfterViewChecked]="AfterViewChecked";var LIFECYCLE_HOOKS_VALUES=[LifecycleHooks.OnInit,LifecycleHooks.OnDestroy,LifecycleHooks.DoCheck,LifecycleHooks.OnChanges,LifecycleHooks.AfterContentInit,LifecycleHooks.AfterContentChecked,LifecycleHooks.AfterViewInit,LifecycleHooks.AfterViewChecked],NgModuleResolver=function(){function NgModuleResolver(_reflector){this._reflector=_reflector}return NgModuleResolver.prototype.isNgModule=function(type){return this._reflector.annotations(type).some(_isNgModuleMetadata)},NgModuleResolver.prototype.resolve=function(type,throwIfNotFound){void 0===throwIfNotFound&&(throwIfNotFound=!0);var ngModuleMeta=findLast(this._reflector.annotations(type),_isNgModuleMetadata);if(ngModuleMeta)return ngModuleMeta;if(throwIfNotFound)throw new Error("No NgModule metadata found for '"+_angular_core.ɵstringify(type)+"'.");return null},NgModuleResolver}();NgModuleResolver.decorators=[{type:CompilerInjectable}],NgModuleResolver.ctorParameters=function(){return[{type:CompileReflector}]};var PipeResolver=function(){function PipeResolver(_reflector){this._reflector=_reflector}return PipeResolver.prototype.isPipe=function(type){var typeMetadata=this._reflector.annotations(_angular_core.resolveForwardRef(type));return typeMetadata&&typeMetadata.some(_isPipeMetadata)},PipeResolver.prototype.resolve=function(type,throwIfNotFound){void 0===throwIfNotFound&&(throwIfNotFound=!0);var metas=this._reflector.annotations(_angular_core.resolveForwardRef(type));if(metas){var annotation=findLast(metas,_isPipeMetadata);if(annotation)return annotation}if(throwIfNotFound)throw new Error("No Pipe decorator found on "+_angular_core.ɵstringify(type));return null},PipeResolver}();PipeResolver.decorators=[{type:CompilerInjectable}],PipeResolver.ctorParameters=function(){return[{type:CompileReflector}]};/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */
var SummaryResolver=function(){function SummaryResolver(){}return SummaryResolver.prototype.isLibraryFile=function(fileName){},SummaryResolver.prototype.getLibraryFileName=function(fileName){},SummaryResolver.prototype.resolveSummary=function(reference){},SummaryResolver.prototype.getSymbolsOf=function(filePath){},SummaryResolver.prototype.getImportAs=function(reference){},SummaryResolver.prototype.addSummary=function(summary){},SummaryResolver}(),JitSummaryResolver=function(){function JitSummaryResolver(){this._summaries=new Map}return JitSummaryResolver.prototype.isLibraryFile=function(fileName){return!1},JitSummaryResolver.prototype.getLibraryFileName=function(fileName){return null},JitSummaryResolver.prototype.resolveSummary=function(reference){return this._summaries.get(reference)||null},JitSummaryResolver.prototype.getSymbolsOf=function(filePath){return[]},JitSummaryResolver.prototype.getImportAs=function(reference){return reference},JitSummaryResolver.prototype.addSummary=function(summary){this._summaries.set(summary.symbol,summary)},JitSummaryResolver}();JitSummaryResolver.decorators=[{type:CompilerInjectable}],JitSummaryResolver.ctorParameters=function(){return[]};/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
