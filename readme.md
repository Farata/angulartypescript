This folder contains code samples from the book "Angular Development with TypeScript", Second Edition (see https://www.manning.com/books/angular-development-with-typescript-second-edition). Currently, all code samples work in Angular 5, but we already started upgrading the code to Angular 6. Accordingly, all Angular 5 samples are located in code-samples/Angular5 and Angular 6 samples will be located in code-samples/Angular5.
